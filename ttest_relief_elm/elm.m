function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy, label_index_actual_new] = elm(train_data, test_data, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
