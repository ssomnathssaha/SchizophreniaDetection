function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,label_index_actual_new] = elm_kernel(train_data, test_data, Elm_Type, Regularization_coefficient, Kernel_type, Kernel_para)
...
%%%%%%%%%% Calculate training & testing classification accuracy
    ...
    for i = 1 : size(TV.T, 2)
        [x, label_index_actual_new(i)]=max(TY(:,i));
    end
    for i = 1 : size(TV.T, 2)
