function [TVT, TY] = mod_elm(train_data, test_data, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
...
InputWeight=rand(NumberofHiddenNeurons,NumberofInputNeurons)*2-1;	%	Random matrix w of (NumberofHiddenNeurons * 3000)
BiasofHiddenNeurons=rand(NumberofHiddenNeurons,1);					%	
tempH=InputWeight*P;								%	P is training data.
